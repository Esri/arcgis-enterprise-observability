...
- ArcGIS_11.5_on_k8s_observability.json: A template for ArcGIS Enterprise on Kubernetes. This template can be used with ArcGIS Enterprise versions 11.5 and 12.0.
